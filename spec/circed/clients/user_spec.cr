...
describe Circed::User do
  ...
  it "should be OK" do
    Circed::User.new("0", "test", "testname").should be_a(Circed::User)
  end

  it "should return stirng" do
    Circed::User.new("0", "test", "testname").to_s.should eq("test 0 :testname")
  end

  it "should access variables" do
    user = Circed::User.new("0", "test", "testname")
